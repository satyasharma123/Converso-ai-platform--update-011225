...
const SYSTEM_STAGES = [
  { id: 'new', label: 'Lead', description: 'Fresh incoming leads' },
  { id: 'engaged', label: 'Engaged', description: 'Leads actively communicating' },
  { id: 'qualified', label: 'Qualified', description: 'Leads meeting qualification criteria' },
  { id: 'converted', label: 'Customer', description: 'Successfully closed deals' },
];
...
export function PipelineStages() {
  ...
  const handleAddStage = async () => {
    ...
    const { error } = await supabase
      ...
      .insert({
        ...
        display_order: customStages.length + SYSTEM_STAGES.length
      });
  ...
  const handleDeleteStage = async () => {
    ...
    // If stage has leads, reassign them to "new" (Lead) stage
    if (hasLeads) {
      const { error: updateError } = await supabase
        .from('conversations')
        .update({ custom_stage_id: null, status: 'new' })
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage the stages leads move through in your sales pipeline
              </CardDescription>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary" className="text-xs">System Stage (Locked)</Badge>
                    </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {hasLeads
                ? 'Leads currently assigned to this stage will automatically move to the "Lead" stage. Are you sure you want to continue?'
