...
-- This tracks the actual count of unread messages for each conversation
...
-- Counts messages where is_from_lead = true that arrived after the conversation was last read
