...
export async function getWorkQueueFromView(
  ...
  // IMPORTANT:
  // DO NOT group, mutate, or normalize here.
  // This function must return RAW rows.
  // Sales Pipeline depends on stable stage_id, pipeline_id, assigned_stage_at.
  // Grouping here overwrites canonical lead-stage mapping.
